...
import java.io.File;
import msm.MemeSena.AppStickerActivity.PrivacyPolicyActivity;
import msm.MemeSena.BuildConfig;
import msm.MemeSena.R;

public class GlobalFun {

    public static final String BASE_URL = "http://admin.memesena.com/api/";
    public static final String API_TOKEN = "memesena";
